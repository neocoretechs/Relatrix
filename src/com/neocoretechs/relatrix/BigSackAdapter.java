 ...
 * The database name is the full path of the top level tablespace and log directory, or if cluster
 * the log of master node and tablespace directories on the remote machines. OR if cluster a remote
 ...
 * The class name is translated into the appropriate file name via a simple translation table.
 * @author jg
 *
 */
