...
* In general, all Streams, Iterators etc. returned by the operators produce {@link Result}s which are
		...
		synchronized(Relatrix.class) {
			if(instance == null) {
				...
				try {
					...
					RelatrixKV.classLoader.connectToLocalRepository(false, false); // transaction param, nojson
