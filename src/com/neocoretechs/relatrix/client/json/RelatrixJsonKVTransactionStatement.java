...
import com.neocoretechs.relatrix.server.json.RelatrixKVJsonTransactionServer;
 ...
 *
 */
public class RelatrixJsonKVTransactionStatement extends RelatrixKVStatement implements RelatrixKVTransactionStatementInterface, Serializable {
	private static final long serialVersionUID = 1452088222610286234L;
	private static boolean DEBUG = false;
    protected TransactionId xid;
    
    public RelatrixJsonKVTransactionStatement() {
    	super();
    	if(DEBUG)
    		System.out.println("Default Constructor:"+this);
    }
    
	public RelatrixJsonKVTransactionStatement(TransactionId xid, String session) {
		super(session);
		this.xid = xid;
	}
	
	public RelatrixJsonKVTransactionStatement(String tmeth, Object ... o1) {
		super(tmeth, o1);
		if(o1.length > 1) {
	...
	public synchronized void process() throws Exception {
		...
		Object result = RelatrixKVJsonTransactionServer.relatrixMethods.invokeMethod(this);
		...
		if( result != null && !((result instanceof Serializable) && !(result instanceof Externalizable))) {					
			...
			RelatrixKVJsonTransactionServer.sessionToObject.put(ric.getSession(), result);
