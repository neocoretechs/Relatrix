...
*/
public class FindSetMode7Json extends IteratorFactory {
	// mode 7
	protected Object darg;
	protected Object marg;
	protected Object rarg;
	protected short[] dmr_return = new short[4];
    public FindSetMode7Json(Object darg, Object marg, Object rarg) throws IllegalArgumentException, IOException { 	
    	this.darg = darg;
    	this.marg = marg;
    	this.rarg = rarg;
    	dmr_return[1] = 0;
