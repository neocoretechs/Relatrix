 ...
 *
 */
public class FindTailSetMode0Json extends FindSetMode0Json {
	Object endarg0,endarg1,endarg2;
	public FindTailSetMode0Json(char dop, char mop, char rop, Object arg1, Object arg2, Object arg3) { 	
		super(dop,mop,rop);
		endarg0 = arg1;
		endarg1 = arg2;
		endarg2 = arg3;
	...
	protected Iterator<?> createRelatrixIterator(AbstractRelation tdmr) throws IllegalAccessException, IOException {
		...
		if(tdmr.getMap() == null) {
			if(endarg1 instanceof Class) {
				xdmr.setMap((Comparable) RelatrixJson.firstKey((Class)endarg1));
			} else {
		...
		if(tdmr.getRange() == null) {
			if(endarg2 instanceof Class) {
				xdmr.setRange((Comparable) RelatrixJson.firstKey((Class)endarg2));
			} else {
	...
	protected Iterator<?> createRelatrixIterator(Alias alias, AbstractRelation tdmr) throws IllegalAccessException, IOException, NoSuchElementException {
		...
		if(tdmr.getMap() == null) {
			if(endarg1 instanceof Class) {
				xdmr.setMap(alias,(Comparable) RelatrixJson.firstKey(alias,(Class)endarg1));
			} else {
		...
		if(tdmr.getRange() == null) {
			if(endarg2 instanceof Class) {
				xdmr.setRange(alias,(Comparable) RelatrixJson.firstKey(alias,(Class)endarg2));
			} else {
