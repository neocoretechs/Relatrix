...
*
*/
public class FindTailSetMode6Json extends FindSetMode6Json {
	Object endarg0;
    public FindTailSetMode6Json(Object darg, Object marg, char rop, Object arg1) { 	
    	super(darg,marg, rop);
		endarg0 = arg1;
    }
	...
	protected Iterator<?> createRelatrixIterator(AbstractRelation tdmr)throws IllegalAccessException, IOException {
		...
		if(tdmr.getRange() == null) {
			if(endarg0 instanceof Class) {
				xdmr.setRange((Comparable) RelatrixJson.firstKey((Class)endarg0));
			} else {
	...
	protected Iterator<?> createRelatrixIterator(Alias alias, AbstractRelation tdmr)throws IllegalAccessException, IOException, NoSuchElementException {
		...
		if(tdmr.getRange() == null) {
			if(endarg0 instanceof Class) {
				xdmr.setRange(alias,(Comparable) RelatrixJson.firstKey(alias,(Class)endarg0));
			} else {
