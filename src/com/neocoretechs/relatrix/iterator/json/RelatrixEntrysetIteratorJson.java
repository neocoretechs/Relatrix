...
public class RelatrixEntrysetIteratorJson implements Iterator<Comparable> {
     ...
     * @throws IOException 
     */
    public RelatrixEntrysetIteratorJson(Class c) throws IOException {
    	try {
     ...
     */
    public RelatrixEntrysetIteratorJson(Alias alias, Class c) throws IOException {
    	this.alias = alias;
    	try {
    ...
    public RelatrixEntrysetIteratorJson(Comparable c) throws IOException {
    	this(c.getClass());
    }
    
    public RelatrixEntrysetIteratorJson(Alias alias, Comparable c) throws IOException {
