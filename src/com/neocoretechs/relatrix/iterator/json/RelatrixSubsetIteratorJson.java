 ...
 *
 */
public class RelatrixSubsetIteratorJson implements Iterator<Result> {
    ...
    public RelatrixSubsetIteratorJson() {}
    /**
     * 
     ...
     * @throws IOException
     */
    public RelatrixSubsetIteratorJson(AbstractRelation template, AbstractRelation templateo, AbstractRelation templatep, short[] dmr_return, ParallelExecutionContext ctx) throws IOException {
       	if(DEBUG)
     ...
     * @throws IOException
     */
    public RelatrixSubsetIteratorJson(Alias alias, AbstractRelation template, AbstractRelation templateo, AbstractRelation templatep, short[] dmr_return, ParallelExecutionContext ctx) throws IOException {
    	this.alias = alias;
    	if(DEBUG)
	...
	public Result next() {
		...
		if( buffer == null || needsIter) {
			if( DEBUGITERATION ) {
	    			System.out.println("RelatrixSubsetIteratorJson.next() before iteration:"+this.toString());
			}
			if( nextit != null )
				buffer = nextit;
		...
		if( DEBUGITERATION ) {
			System.out.println("RelatrixSubsetIteratorJson.next() template match after iteration:"+this.toString());
		}
