...
*
*/
public class FindSetMode1JsonTransaction extends FindSetMode1Json {
	// mode 1
	TransactionId xid;
    public FindSetMode1JsonTransaction(TransactionId transactionId, char dop, char mop, Object rarg) { 	
    	super(dop, mop, rarg);
