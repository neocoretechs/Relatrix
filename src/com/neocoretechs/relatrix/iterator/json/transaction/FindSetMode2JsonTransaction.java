...
* 
*/
public class FindSetMode2JsonTransaction extends FindSetMode2Json {
	// mode 2
	TransactionId xid;
    public FindSetMode2JsonTransaction(TransactionId transactionId, char dop, Object marg, char rop) { 	
    	super(dop, marg, rop);
