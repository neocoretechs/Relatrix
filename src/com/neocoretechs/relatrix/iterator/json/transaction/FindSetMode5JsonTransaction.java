...
* 
*/
public class FindSetMode5JsonTransaction extends FindSetMode5Json {
	// mode 5
	TransactionId xid;
    public FindSetMode5JsonTransaction(TransactionId transactionId, Object darg, char mop, Object rarg) { 	
    	super(darg, mop, rarg);
