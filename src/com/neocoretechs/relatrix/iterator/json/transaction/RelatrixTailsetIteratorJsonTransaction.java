 ...
 *
 */
public class RelatrixTailsetIteratorJsonTransaction extends RelatrixTailsetIteratorJson {
	public static boolean DEBUG = false;
	TransactionId xid;
    
    public RelatrixTailsetIteratorJsonTransaction() {}
    /**
	...
	public boolean hasNext() {
		if( DEBUGITERATION )
			System.out.println("RelatrixTailsetIteratorJsonTransaction.hasNext() xid:"+xid+" "+super.toString());
		return needsIter;	
	}
	...
	public Result next() {
		...
		if( buffer == null || needsIter) {
			if( DEBUGITERATION ) {
	    			System.out.println("RelatrixTailsetIteratorJsonTransaction.next() before iteration xid:"+xid+" "+super.toString());
			}
			if( nextit != null )
				buffer = nextit;
		...
		if( DEBUGITERATION ) {
			System.out.println("RelatrixIteratorJsonTransaction.next() template match after iteration xid:"+xid+" "+super.toString());
		}
