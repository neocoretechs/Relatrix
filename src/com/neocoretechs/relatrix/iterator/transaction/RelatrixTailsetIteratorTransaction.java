    	...
    	try {
    		...
    		if(template.getDomain() != null) {
    			...
    			if(templateo.getDomain() != null) {
    				...
    				ConcurrentLinkedQueue<DBKey> q = RelatrixKVTransaction.findTailMapKVStream(xid, templateo.getDomain())
    		...
    		if(template.getMap() != null) {
    			...
    			if(templateo.getMap() != null) {
    				...
    				ConcurrentLinkedQueue<DBKey> q = RelatrixKVTransaction.findTailMapKVStream(xid, templateo.getMap())
    						.map(e -> ((Map.Entry<Comparable,DBKey>) e).getValue())
    						.collect(Collectors.toCollection(ConcurrentLinkedQueue::new));
    		...
    		if(template.getRange() != null) {
    			...
    			if(templateo.getRange() != null) {
    				...
    				ConcurrentLinkedQueue<DBKey> q = RelatrixKVTransaction.findTailMapKVStream(xid, templateo.getRange())
    						.map(e -> ((Map.Entry<Comparable,DBKey>) e).getValue())
    						.collect(Collectors.toCollection(ConcurrentLinkedQueue::new));
    	...
    	try {
    		if(template.getDomain() != null) {
    			...
    			if(templateo.getDomain() != null) {
    				...
    				ConcurrentLinkedQueue<DBKey> q = RelatrixKVTransaction.findTailMapKVStream(alias, xid, templateo.getDomain())
    						.map(e -> ((Map.Entry<Comparable,DBKey>) e).getValue())
    						.collect(Collectors.toCollection(ConcurrentLinkedQueue::new));
    				dkey.addAll(q); // single-threaded merge
    				// compute lo/hi
    		...
    		if(template.getMap() != null) {
    			...
    			if(templateo.getMap() != null) {
    				/*RelatrixKVTransaction.findTailMapKVStream(alias,xid,templateo.getMap()).forEach(e -> {
     				...
     				ConcurrentLinkedQueue<DBKey> q = RelatrixKVTransaction.findTailMapKVStream(alias, xid, templateo.getMap())
    						.map(e -> ((Map.Entry<Comparable,DBKey>) e).getValue())
    						.collect(Collectors.toCollection(ConcurrentLinkedQueue::new));
    				mkey.addAll(q); // single-threaded merge
    				// compute lo/hi
    		...
    		if(template.getRange() != null) {
    			...
    			if(templateo.getRange() != null) {
    				/*RelatrixKVTransaction.findTailMapKVStream(alias,xid,templateo.getRange()).forEach(e -> {
     				...
     				ConcurrentLinkedQueue<DBKey> q = RelatrixKVTransaction.findTailMapKVStream(alias, xid, templateo.getRange())
    						.map(e -> ((Map.Entry<Comparable,DBKey>) e).getValue())
    						.collect(Collectors.toCollection(ConcurrentLinkedQueue::new));
    				rkey.addAll(q); // single-threaded merge
    				// compute lo/hi
