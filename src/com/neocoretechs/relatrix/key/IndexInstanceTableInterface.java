...
public interface IndexInstanceTableInterface {
	 ...
	 */
	DBKey put(Object instance) throws IllegalAccessException, IOException, ClassNotFoundException;
	/**
	 * Put the key to the proper tables
	 * @return the DBKey
	 * @throws IllegalAccessException
	 ...
	 * @throws ClassNotFoundException
	 */
	DBKey put(TransactionId transactionId, Object instance) throws IllegalAccessException, IOException, ClassNotFoundException;	
	/**
	 * Put the key to the proper tables
	 * @return The DBKey
	 * @throws IllegalAccessException
	 ...
	 * @throws ClassNotFoundException
	 */
	DBKey put(Alias alias, Object instance) throws IllegalAccessException, IOException, ClassNotFoundException, NoSuchElementException;
	/**
	 * Put the key to the proper tables
	 * @return The DBKey
	 * @throws IllegalAccessException
	 ...
	 * @throws ClassNotFoundException
	 */
	DBKey put(Alias alias, TransactionId transactionId, Object instance) throws IllegalAccessException, IOException, ClassNotFoundException, NoSuchElementException;
	/**
	 ...
	 * @throws ClassNotFoundException
	 */
	void put(DBKey dbKey, Object instance) throws IllegalAccessException, IOException, ClassNotFoundException;
	/**
	 * Put the key to the proper tables. The operation is a simple K/V put using {@link RelatrixKV} since we
	 * form the {@link DBKey} when we set the values of domain/map/range in the mutator methods of {@link AbstractRelation}, and
	 * the proper instances are placed in their rightful databases at that time. Here we are just storing the
	 ...
	 */
	void put(Alias alias, DBKey index, Object instance) throws IllegalAccessException, IOException, ClassNotFoundException, NoSuchElementException;
	/**
	 * Put the key to the proper tables. The operation is a simple K/V put using {@link RelatrixKV} since we
	 * form the {@link DBKey} when we set the values of domain/map/range in the mutator methods of {@link AbstractRelation}, and
	 * the proper instances are placed in their rightful databases at that time. Here we are just storing the
	 ...
	 * @throws ClassNotFoundException
	 */
	void put(TransactionId transactionId, DBKey index, Object instance) throws IllegalAccessException, IOException, ClassNotFoundException, NoSuchElementException;
	/**
	 ...
	 */
	void put(Alias alias, TransactionId transactionId, DBKey index, Object instance) throws IllegalAccessException, IOException, ClassNotFoundException, NoSuchElementException;
