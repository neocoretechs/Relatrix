...
public class ServerSideRemoteHeadSetIterator extends RemoteIterator {
	...
	public ServerSideRemoteHeadSetIterator(String session) throws ClassNotFoundException {
		super(session);
		if(relatrixHeadsetMethods == null)
			relatrixHeadsetMethods = new ServerInvokeMethod("com.neocoretechs.relatrix.iterator.RelatrixHeadsetIterator", 0);
	}
