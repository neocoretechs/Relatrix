...
public class ServerSideRemoteTailSetIterator extends RemoteIterator {
	...
	public ServerSideRemoteTailSetIterator(String session) throws ClassNotFoundException {
		super(session);
		if(relatrixTailsetMethods == null)
			relatrixTailsetMethods = new ServerInvokeMethod("com.neocoretechs.relatrix.iterator.RelatrixTailsetIterator", 0);
	}
