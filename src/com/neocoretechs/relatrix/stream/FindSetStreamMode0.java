...
* domain,map,range 3 element array for each iteration. This mode return a one to three element {@link Result}
* depending on the configuration of the findSet. The number of "?" elements PLUS the number of concrete
* target range objects specified determines the size of the returned  {@link Result}.<p/>
