...
/**
* Find the tail set of objects in the relation via the specified predicate. Legal permutations are:<br/>
* *,[object],[object],... <br/>
* *,?,[object],[object],... <br/>
* @author Jonathan Groff Copyright (C) NeoCoreTechs 2014,2015,2021 
*/
public class FindTailSetStreamMode3 extends FindSetStreamMode3 {
	Object[] endarg;
    public FindTailSetStreamMode3(char dop, Object marg, Object rarg, Object ... endarg) { 	
    	super(dop, marg, rarg);
      	if(endarg.length != 1)
