	...
	*/
	...
	public static void battery1(String[] argv) throws Exception {
		...
		for(int i = min; i < max; i++) {
			...
			// cannot be inserted
			Relation identity = RelatrixTransaction.store(xid,d,m,r);
			...
			Relation identity2 = RelatrixTransaction.store(xid, identity, m, r);
			// store in mirror table
	...
	public static void battery1AR5(String[] argv) throws Exception {
		...
		Object i;
		long tims = System.currentTimeMillis();
		Iterator<?> its = RelatrixKVTransaction.entrySet(xid,Relation.class);
